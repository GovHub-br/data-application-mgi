...
@dag(
    dag_id="resultado_itens_contratacoes_dag",
    schedule="0 4 * * *",
...
def resultado_itens_contratacoes_dag() -> None:
    ...
    def get_page_starts(**context: object) -> list[int]:
        ...
        _, resp = api.request(
            "GET", ENDPOINT,
            params={"dataResultadoPncpInicial": data_inicial, "dataResultadoPncpFinal": data_final, "bps": "false", "pagina": 1, "tamanhoPagina": PAGE_SIZE},
        )
    ...
    def fetch_block(pagina_inicio: int, **context: object) -> dict:
        ...
        for pagina in range(pagina_inicio, pagina_inicio + BLOCK_SIZE):
            ...
            _, resp = api.request(
                "GET", ENDPOINT,
                params={"dataResultadoPncpInicial": data_inicial, "dataResultadoPncpFinal": data_final, "bps": "false", "pagina": pagina, "tamanhoPagina": PAGE_SIZE},
            )
